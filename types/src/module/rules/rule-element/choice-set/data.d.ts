...
import type { DataUnionField, PredicateField, StrictArrayField, StrictBooleanField, StrictNumberField, StrictObjectField, StrictStringField } from "@system/schema-data-fields.ts";
...
type ChoiceSetSchema = RuleElementSchema & {
    ...
    allowedDrops: fields.SchemaField<AllowedDropsSchema, SourceFromSchema<AllowedDropsSchema>, ModelPropsFromSchema<AllowedDropsSchema>, false, true, false>;
