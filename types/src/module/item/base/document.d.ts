...
declare class ItemPF2e<TParent extends ActorPF2e | null = ActorPF2e | null> extends Item<TParent> {
    ...
    static _preUpdateOperation(documents: foundry.abstract.Document<foundry.abstract._Document | null, foundry.data.fields.DataSchema>[], operation: ItemPF2eDatabaseUpdateOperation, user: foundry.documents.BaseUser<foundry.documents.BaseActor<null>>): Promise<boolean | void>;
    /** Overriden to handle max hp updates when certain items changes. These updates should not occur due to temporary changes */
    static _onUpdateOperation(documents: foundry.abstract.Document<foundry.abstract._Document | null, foundry.data.fields.DataSchema>[], operation: ItemPF2eDatabaseUpdateOperation, user: foundry.documents.BaseUser<foundry.documents.BaseActor<null>>): Promise<void>;
