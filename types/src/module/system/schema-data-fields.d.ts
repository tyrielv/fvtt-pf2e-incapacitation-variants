...
/** @todo Remove in V13 */
declare class NullCoercingNumberField<TSourceProp extends number = number, TModelProp extends NonNullable<JSONValue> = TSourceProp, TRequired extends boolean = false, TNullable extends boolean = true, THasInitial extends boolean = true> extends fields.NumberField<TSourceProp, TModelProp, TRequired, TNullable, THasInitial> {
    protected _cast(value: unknown): unknown;
}
...
declare class AnyChoiceField<TChoices extends JSONValue, TRequired extends boolean = true, TNullable extends boolean = false, THasInitial extends boolean = true> extends fields.DataField<TChoices, TChoices, TRequired, TNullable, THasInitial> {
    protected _cast(value: unknown): unknown;
...
export { AnyChoiceField, DataUnionField, LaxArrayField, LaxSchemaField, NullCoercingNumberField, NullField, PredicateField, RecordField, SlugField, StrictArrayField, StrictBooleanField, StrictNumberField, StrictObjectField, StrictSchemaField, StrictStringField, };
